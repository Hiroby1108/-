...
public class ResultTextSet : MonoBehaviour{
    ...
    void Start(){
        ...
        /*ResultUI_1_1 = GameObject.Find("ResultText1_1");
    ...
    private void TextTransparence_1(){    //最初のリザルト画面(回収したごみの表示テキスト）の非表示
        Destroy(ResultUI_1);
        //ResultUI_1.GetComponent<Text>().enabled = false;
    ...
    private void TextDisplay_2(){
        ResultUI_2.GetComponent<Canvas>().enabled = true;
        //ResultUI_22.GetComponent<Text>().enabled = true;
    }
}
