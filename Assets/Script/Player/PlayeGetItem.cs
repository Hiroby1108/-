...
{
    private static Dictionary<string, int> LivingList = new Dictionary<string, int>(){/*{ "tabako(Clone)", 0}, { "Petbotol(Clone)", 0 }, { "Gyomou(Clone)", 0 },
                                                                                      { "Taiya(Clone)", 0},{ "Terebi(Clone)", 0},{ "Biniru(Clone)", 0}*/};//Livingタグのオブジェクト名と個数を取得,保存
